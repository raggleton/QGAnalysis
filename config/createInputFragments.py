...
DO_THESE = [
('MC_DYJetsToLL_M-50_HT-70to100', '../datasets/MG-Pythia/DYJetsToLL_HT70to100.xml'),
('MC_DYJetsToLL_M-50_HT-100to200', '../datasets/MG-Pythia/DYJetsToLL_HT100to200.xml'),
('MC_DYJetsToLL_M-50_HT-200to400', '../datasets/MG-Pythia/DYJetsToLL_HT200to400.xml'),
('MC_DYJetsToLL_M-50_HT-400to600', '../datasets/MG-Pythia/DYJetsToLL_HT400to600.xml'),
('MC_DYJetsToLL_M-50_HT-600to800', '../datasets/MG-Pythia/DYJetsToLL_HT600to800.xml'),
('MC_DYJetsToLL_M-50_HT-800to1200', '../datasets/MG-Pythia/DYJetsToLL_HT800to1200.xml'),
('MC_DYJetsToLL_M-50_HT-1200to2500', '../datasets/MG-Pythia/DYJetsToLL_HT1200to2500.xml'),
('MC_DYJetsToLL_M-50_HT-2500toInf', '../datasets/MG-Pythia/DYJetsToLL_HT2500toInf.xml'),
('MC_QCD_HT50to100', '../datasets/MG-Pythia/QCD_HT50to100.xml'),
('MC_QCD_HT100to200', '../datasets/MG-Pythia/QCD_HT100to200.xml'),
('MC_QCD_HT200to300', '../datasets/MG-Pythia/QCD_HT200to300.xml'),
('MC_QCD_HT300to500', '../datasets/MG-Pythia/QCD_HT300to500.xml'),
('MC_QCD_HT500to700', '../datasets/MG-Pythia/QCD_HT500to700.xml'),
('MC_QCD_HT700to1000', '../datasets/MG-Pythia/QCD_HT700to1000.xml'),
('MC_QCD_HT1000to1500', '../datasets/MG-Pythia/QCD_HT1000to1500.xml'),
('MC_QCD_HT1500to2000', '../datasets/MG-Pythia/QCD_HT1500to2000.xml'),
('MC_QCD_HT2000toInf', '../datasets/MG-Pythia/QCD_HT2000toInf.xml'),
]
