...
protected:
    ...
    TH2F *h_tu_response_LHA, *h_tu_response_LHA_half; // response matrices. *_half histograms use half the MC to act as a check using independent sets of events
    TH1F *h_tu_reco_LHA, *h_tu_reco_LHA_fake, *h_tu_reco_LHA_half, *h_tu_reco_LHA_fake_half;  // detector quantities with reco binning
    TH1F *h_tu_reco_LHA_gen_binning, *h_tu_reco_LHA_fake_gen_binning, *h_tu_reco_LHA_gen_binning_half, *h_tu_reco_LHA_fake_gen_binning_half; // detector quantities with gen binning
    TH1F *h_tu_gen_LHA, *h_tu_gen_LHA_half; // truth histograms
    ...
    TH1F *h_tu_reco_puppiMultiplicity, *h_tu_reco_puppiMultiplicity_fake, *h_tu_reco_puppiMultiplicity_half, *h_tu_reco_puppiMultiplicity_fake_half;
    TH1F *h_tu_reco_puppiMultiplicity_gen_binning, *h_tu_reco_puppiMultiplicity_fake_gen_binning, *h_tu_reco_puppiMultiplicity_gen_binning_half, *h_tu_reco_puppiMultiplicity_fake_gen_binning_half;
    TH1F *h_tu_gen_puppiMultiplicity, *h_tu_gen_puppiMultiplicity_half;
    ...
    TH1F *h_tu_reco_pTD, *h_tu_reco_pTD_fake, *h_tu_reco_pTD_half, *h_tu_reco_pTD_fake_half;
    TH1F *h_tu_reco_pTD_gen_binning, *h_tu_reco_pTD_fake_gen_binning, *h_tu_reco_pTD_gen_binning_half, *h_tu_reco_pTD_fake_gen_binning_half;
    TH1F *h_tu_gen_pTD, *h_tu_gen_pTD_half;
    ...
    TH1F *h_tu_reco_thrust, *h_tu_reco_thrust_fake, *h_tu_reco_thrust_half, *h_tu_reco_thrust_fake_half;
    TH1F *h_tu_reco_thrust_gen_binning, *h_tu_reco_thrust_fake_gen_binning, *h_tu_reco_thrust_gen_binning_half, *h_tu_reco_thrust_fake_gen_binning_half;
    TH1F *h_tu_gen_thrust, *h_tu_gen_thrust_half;
    ...
    TH1F *h_tu_reco_width, *h_tu_reco_width_fake, *h_tu_reco_width_half, *h_tu_reco_width_fake_half;
    TH1F *h_tu_reco_width_gen_binning, *h_tu_reco_width_fake_gen_binning, *h_tu_reco_width_gen_binning_half, *h_tu_reco_width_fake_gen_binning_half;
    TH1F *h_tu_gen_width, *h_tu_gen_width_half;
    ...
    TH1F *h_tu_reco_LHA_charged, *h_tu_reco_LHA_charged_fake, *h_tu_reco_LHA_charged_half, *h_tu_reco_LHA_charged_fake_half;
    TH1F *h_tu_reco_LHA_charged_gen_binning, *h_tu_reco_LHA_charged_fake_gen_binning, *h_tu_reco_LHA_charged_gen_binning_half, *h_tu_reco_LHA_charged_fake_gen_binning_half;
    TH1F *h_tu_gen_LHA_charged, *h_tu_gen_LHA_charged_half;
    ...
    TH1F *h_tu_reco_puppiMultiplicity_charged, *h_tu_reco_puppiMultiplicity_charged_fake, *h_tu_reco_puppiMultiplicity_charged_half, *h_tu_reco_puppiMultiplicity_charged_fake_half;
    TH1F *h_tu_reco_puppiMultiplicity_charged_gen_binning, *h_tu_reco_puppiMultiplicity_charged_fake_gen_binning, *h_tu_reco_puppiMultiplicity_charged_gen_binning_half, *h_tu_reco_puppiMultiplicity_charged_fake_gen_binning_half;
    TH1F *h_tu_gen_puppiMultiplicity_charged, *h_tu_gen_puppiMultiplicity_charged_half;
    ...
    TH1F *h_tu_reco_pTD_charged, *h_tu_reco_pTD_charged_fake, *h_tu_reco_pTD_charged_half, *h_tu_reco_pTD_charged_fake_half;
    TH1F *h_tu_reco_pTD_charged_gen_binning, *h_tu_reco_pTD_charged_fake_gen_binning, *h_tu_reco_pTD_charged_gen_binning_half, *h_tu_reco_pTD_charged_fake_gen_binning_half;
    TH1F *h_tu_gen_pTD_charged, *h_tu_gen_pTD_charged_half;
    ...
    TH1F *h_tu_reco_thrust_charged, *h_tu_reco_thrust_charged_fake, *h_tu_reco_thrust_charged_half, *h_tu_reco_thrust_charged_fake_half;
    TH1F *h_tu_reco_thrust_charged_gen_binning, *h_tu_reco_thrust_charged_fake_gen_binning, *h_tu_reco_thrust_charged_gen_binning_half, *h_tu_reco_thrust_charged_fake_gen_binning_half;
    TH1F *h_tu_gen_thrust_charged, *h_tu_gen_thrust_charged_half;
    ...
    TH1F *h_tu_reco_width_charged, *h_tu_reco_width_charged_fake, *h_tu_reco_width_charged_half, *h_tu_reco_width_charged_fake_half;
    TH1F *h_tu_reco_width_charged_gen_binning, *h_tu_reco_width_charged_fake_gen_binning, *h_tu_reco_width_charged_gen_binning_half, *h_tu_reco_width_charged_fake_gen_binning_half;
    TH1F *h_tu_gen_width_charged, *h_tu_gen_width_charged_half;
